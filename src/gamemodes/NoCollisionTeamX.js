'use strict';
var Teams = require('./NoCollisionTeams.js');
...
TeamX.prototype.onServerInit = function (gameServer) {
  ...
  if (!this.teamCollision) {
    this.onCellMove = function (x1, y1, cell) {
    }; // does nothing
...
MotherCell.prototype.spawnFood = function (gameServer) {
  ...
  // Spawn food
  var f = new Food(gameServer.getWorld().getNextNodeId(), null, pos, gameServer.config.foodMass);
